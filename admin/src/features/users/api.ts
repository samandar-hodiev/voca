// users: backend API calls.
//
// Browse and inspect learner accounts, their progress and their entitlement. Read-mostly; destructive actions require an explicit backend permission.
//
